...
* automatisierte versionisierte Dokumentation mit https://datahandwerk.gitlab.io/[DataHandwerk DocsGenerator] (Kombination von technischer und fachlicher Dokumentation; https://asciidoc.org/[AsciiDoc], link:[https:](https://antora.org/)[Antora (Docs as Code)])
