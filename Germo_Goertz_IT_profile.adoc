...
:page-subtitle: Microsoft BI Architekt + Entwickler. MS SQL Server, Power BI, SSAS (OLAP und Tabular), Data Warehouse, Lakehouse, ELT, ETL, automatisierte Dokumentation, DataHandwerk
:page-last-updated: 2023-04-20
