...
:page-subtitle: Microsoft BI Architekt + Entwickler. MS SQL Server, SSAS, DWH, ELT statt ETL, automatisierte Dokumentation
...
:fn-blog-docs: footnote:blog-docs[Mehr zum Docs-as-Code im Blog-Artikel https://datahandwerk.aisberg.de/2021-04-20-docs-code-mit-asciidoc-und-antora/[]]
:fn-blog-dhw: footnote:blog-dhw[Warum es das DataHandwerk Projekt gibt: im Blog-Artikel https://datahandwerk.aisberg.de/2021-03-23-datahandwerk-toolkit-mssql/[]]
...
* automatisierte versionisierte Dokumentation mit https://datahandwerk.gitlab.io/dhw/user-guide/documentation-generator.html/[DataHandwerk DocsGenerator]{fn-blog-docs} (Kombination von technischer und fachlicher Dokumentation; https://docs.asciidoctor.org/asciidoc/latest/[Asciidoc], https://antora.org/[*Antora* (Docs as Code)])
...
:fn-blog-kh-autobauer: footnote:kh-autobauer[Hintergründe zu "Technokratie statt Demokratie" im "Gleichnis vom Krankenhaus" https://datahandwerk.aisberg.de/2022-09-15-krankenhaus-autobauer/[]]

* Exzellenz durch Kompetenz
* Handwerk statt Fließband
* Technokratie statt Demokratie: +
Vertrauen in Experten{fn-blog-kh-autobauer}
