...
:fn-blog-docs: footnote:blog-docs[Mehr dazu im Blog-Artikel https://datahandwerk.aisberg.de/2021-04-20-docs-code-mit-asciidoc-und-antora/[]]
:fn-blog-dhw: footnote:blog-dhw[Warum es das Projekt gibt: im Blog-Artikel https://datahandwerk.aisberg.de/2021-03-23-datahandwerk-toolkit-mssql/[]]
...
* automatisierte versionisierte Dokumentation mit https://datahandwerk.gitlab.io/[DataHandwerk DocsGenerator]{fn-blog-docs} (Kombination von technischer und fachlicher Dokumentation; https://docs.asciidoctor.org/asciidoc/latest/[Asciidoc], https://antora.org/[*Antora* (Docs as Code)])
...
:fn-blog-kh-autobauer: footnote:kh-autobauer[Hintergründe im Blog-Artikel https://datahandwerk.aisberg.de/2022-09-15-krankenhaus-autobauer/[]]
