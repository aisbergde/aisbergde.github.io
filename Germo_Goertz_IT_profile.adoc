...
:page-subtitle: Microsoft BI Architekt + Entwickler. MS SQL Server, Power BI, SSAS (OLAP, Tabular), Data Warehouse, Lakehouse, ELT, ETL, automatisierte Dokumentation, DataHandwerk, Microsoft Fabric
:page-last-updated: 2023-06-21
...
Microsoft sieht die Zukunft in der Cloud: *Power BI Services*; und inzwischen *Microsoft Fabric*, basierend auf einem *OneLake*.
...
\=> Was sich mit Power BI oder SSAS Tabular realisieren lässt, wird von mir pragmatisch mit Tabular gemacht. Falls nötig und sinnvoll, gibt es weiter OLAP (Man fragt sich, wie lange noch, und wie zukunftssicher neue OLAP Modelle wohl wären). Vermutlich verschiebt sich die Modellierung aus SSAS oder Power BI in den OneLake der Microsoft Fabric.
