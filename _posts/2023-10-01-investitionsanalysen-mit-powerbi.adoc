...
:page-tags: ["Alternative Investition", "Power BI", "Szenarien"]
:toc: auto
:toclevels: 2
...
Es gibt Parameter pro Investition. Und es gibt Paramter pro Kombination aus Investition und Finanzierung:
...
Über das Kontext-Menü der Diagramme kann man das Diagram fokusieren und auch die einzelnen Datenpunkte als Tabelle sehen.
