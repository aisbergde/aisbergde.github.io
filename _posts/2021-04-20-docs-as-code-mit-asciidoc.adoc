...
obwohl es immer noch keinen Android Editor mit AsciiDoc Unterstützung gibt, habe ich mein Notizen-System von Markdown auf AsciiDoc umgestellt. Die Notizen befinden sich in einem privaten Repository auf Gitlab, es gibt für Android einen Git-Client https://github.com/maks/Mgit[MGit], als Editor verwende ich weiter https://github.com/gsantner/markor#readme[Markor].

*Update (2024-07):*

Seit längerer Zeit enthält Markor auch eine eingebaute AsciiDoc Anzeige. Der Umweg über den lokalen Webserver ist nicht mehr nötig.

*obsolete (2024-07):*

der Preview erfolgt über einen lokalen Webserver, ich verwendete dazu den im Play Store nicht mehr verfügbaren *NiM Webserver*, aber es gibt andere Webserver.
// https://play.google.com/store/apps/details?id=com.nimcomputing.webserver&hl=gsw&gl=US[NiM Webserver], 
Die Anzeige erfolgt mit der https://chrome.google.com/webstore/detail/asciidoctorjs-live-previe/iaalpfgpbocpdfblpnhhgllgbdbchmia?hl=en[Asciidoctor.js Live Preview] im https://kiwibrowser.com/[KiwiBrowser]
