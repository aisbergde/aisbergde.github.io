= Meine Vision eines Werkzeugkastens für Daten-Handwerker
...
Seit 2017 verwende ich den https://www.analyticscreator.com/[AnalyticsCreator]. Das Konzept des AnalyticsCreators besteht u. a. darin, ein DWH mit den dazugehörigen ETL-Prozessen und sogar SSAS-Datenbanken _vollständig_ über ein Repository zu definieren und mit dem AnalyticsCreator zu erstellen. Neben vielen Vorteilen, die ich in einem anderen Artikel link:../2020-04-26-warum-analyticscreator/["Warum AnalyticsCreator"] beschrieb, gibt es auch _Einschränkungen_:
